...
import { API_PORT_FORWARD, API_SYSTEM, WorkloadKind, type ForwardConfig, type SystemApi, type PortForwardApi, type PortForwardsInfo } from '@kubernetes-dashboard/channels';
