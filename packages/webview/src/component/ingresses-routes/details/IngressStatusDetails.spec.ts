...
import IngressStatusDetails from './IngressStatusDetails.svelte';
...
describe('KubeIngressStatusArtifact', () => {
  test('renders load balancer ingress information correctly', async () => {
    render(IngressStatusDetails, { status: validIngressStatus });
  ...
  test('does not render without loadBalancer.ingress', async () => {
    ...
    render(IngressStatusDetails, { status: invalidIngressStatus });
