...
import PodStatusDetails from './PodStatusDetails.svelte'; // Adjust the import path as necessary
...
test('Renders pod status correctly with hardcoded values', () => {
  render(PodStatusDetails, { status: fakePodStatus });
...
test('show container statuses when present', () => {
  ...
  render(PodStatusDetails, { status: fakePodStatusWithContainers });
